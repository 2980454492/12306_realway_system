...
const UI = {
  ...
  /** showAddTrainForm 的实际逻辑（确保邻居索引已就绪） */
  _showAddTrainFormImpl: function() {
  ...
  /** 从已有列车 segments+stops 重建 routePath（编辑模式用） */
  _buildRoutePathFromTrain: function(train) {
